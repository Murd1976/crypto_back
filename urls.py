...
urlpatterns = [
    ...
    path('reports/txt/delete/<str:files>/', views.delete_txt_report, name='my_delete_txt_reports'),
    path('reports/xlsx/', views.reports_xlsx_files_list, name='my_xlsx_reports'),
    path('reports/xlsx/delete/<str:files>/', views.delete_xlsx_report, name='my_delete_xlsx_reports'),
    re_path(r'^download/$', views.download_report),
    path('tests/', views.tests_list_page, name= 'my_tests_list'),
    path('tests/delete/<str:files>/', views.delete_tests, name= 'my_delete_tests'),
